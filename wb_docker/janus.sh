...
while [ -n "${API_NAME}" ]; do
    ...
    eval WB_AUTH_PLUGIN=\$${API_ENV}_WB_AUTH_PLUGIN
    ...
    eval WB_AUTH_ACCESS_KEY_HEADER=\$${API_ENV}_WB_AUTH_ACCESS_KEY_HEADER
    eval WB_AUTH_SECRET_KEY_HEADER=\$${API_ENV}_WB_AUTH_SECRET_KEY_HEADER
    eval WB_AUTH_TOKEN_HEADER=\$${API_ENV}_WB_AUTH_TOKEN_HEADER
    eval WB_AUTH_CLIENT_ID_HEADER=\$${API_ENV}_WB_AUTH_CLIENT_ID_HEADER
    eval WB_AUTH_USER_ID_HEADER=\$${API_ENV}_WB_AUTH_USER_ID_HEADER
